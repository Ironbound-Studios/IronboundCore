...
public class CapabilityRegistry {
    private static final DeferredRegister<AttachmentType<?>> ATTACHMENT_TYPE_DEFERRED_REGISTER = DeferredRegister.create(NeoForgeRegistries.ATTACHMENT_TYPES, MODID);

    public static final Supplier<AttachmentType<StatusAttachement>> STATUS_DATA = ATTACHMENT_TYPE_DEFERRED_REGISTER.register(
            "status_data", () -> AttachmentType.serializable(StatusAttachement::new).build()
    );
}
