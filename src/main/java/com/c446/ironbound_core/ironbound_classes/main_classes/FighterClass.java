...
public class FighterClass extends IBClass {
    ...
    static {
        instance.addAttribute(MAX_HEALTH, new AttributeModifier(Ironbound.prefix("class_hp"), 6, AttributeModifier.Operation.ADD_VALUE));
        instance.addAttribute(MAX_MANA, new AttributeModifier(Ironbound.prefix("class_mana"), 5, AttributeModifier.Operation.ADD_VALUE));
        instance.addAttribute(FOCUS, new AttributeModifier(Ironbound.prefix("class_focus"), 0, AttributeModifier.Operation.ADD_VALUE));
        instance.addAttribute(VITALITY, new AttributeModifier(Ironbound.prefix("class_vitality"), 1, AttributeModifier.Operation.ADD_VALUE));
        ...
        instance.addAttribute(ATTACK_DAMAGE, new AttributeModifier(Ironbound.prefix("class_attack_damage"), 0.025, AttributeModifier.Operation.ADD_MULTIPLIED_BASE));
        instance.addAttribute(ATTACK_SPEED, new AttributeModifier(Ironbound.prefix("class_attack_speed"), 0.025, AttributeModifier.Operation.ADD_MULTIPLIED_BASE));
