...
public class SorcererClass extends IBClass {
    ...
    static{
        ...
        instance.addAttribute(SPELL_POWER, new AttributeModifier(Ironbound.prefix(instance.classId.getPath() + "_spell_power"), 0.0125, AttributeModifier.Operation.ADD_MULTIPLIED_BASE));
