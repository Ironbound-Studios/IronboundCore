...
public class HunterClass extends IBClass {
    ...
    static {
        ...
        instance.addAttribute(ARMOR_SHRED, new AttributeModifier(Ironbound.prefix("class_armor_shred"), 0.025, AttributeModifier.Operation.ADD_MULTIPLIED_BASE));
        instance.addAttribute(PROT_SHRED, new AttributeModifier(Ironbound.prefix("class_protection_shred"), 0.025, AttributeModifier.Operation.ADD_MULTIPLIED_BASE));
    }
