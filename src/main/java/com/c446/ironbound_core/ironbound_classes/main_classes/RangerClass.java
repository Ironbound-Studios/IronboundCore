...
public class RangerClass extends IBClass {
    ...
    static {
        ...
        instance.addAttribute(ARROW_DAMAGE, new AttributeModifier(Ironbound.prefix(instance.classId.getPath() + "_arrow_damage"), 0.025, AttributeModifier.Operation.ADD_MULTIPLIED_BASE));
        instance.addAttribute(ARROW_VELOCITY, new AttributeModifier(Ironbound.prefix(instance.classId.getPath() + "_arrow_velocity"), 0.025, AttributeModifier.Operation.ADD_MULTIPLIED_BASE));
