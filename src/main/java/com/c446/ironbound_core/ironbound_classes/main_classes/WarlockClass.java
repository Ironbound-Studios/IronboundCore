...
public class WarlockClass extends IBClass {

    public static WarlockClass instance = new WarlockClass(Ironbound.prefix("warlock_class"));
    ...
    static {
        ...
        instance.addAttribute(COOLDOWN_REDUCTION, new AttributeModifier(Ironbound.prefix(instance.classId.getPath() + "_cooldown_reduc"), 0.05, AttributeModifier.Operation.ADD_MULTIPLIED_BASE));
        instance.addAttribute(MANA_REGEN, new AttributeModifier(Ironbound.prefix(instance.classId.getPath() + "_mana_regen"), 0.0125, AttributeModifier.Operation.ADD_MULTIPLIED_BASE));
    ...
    protected WarlockClass(ResourceLocation classId) {
        super(classId);
    }
