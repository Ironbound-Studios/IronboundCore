...
public class WarlockClass extends IBClass {
    ...
    static {
        ...
        instance.addAttribute(COOLDOWN_REDUCTION, new AttributeModifier(Ironbound.prefix("class" + "_cooldown_reduc"), 0.05, AttributeModifier.Operation.ADD_MULTIPLIED_BASE));
