...
public class SimulacrumRenderer extends LivingEntityRenderer<SimulacrumEntity, PlayerModel<SimulacrumEntity>> {
    ...
    public SimulacrumRenderer(EntityRendererProvider.Context p_i46102_1_) {
    ...
    @Override
    protected void setupRotations(SimulacrumEntity p_225621_1_, @NotNull PoseStack p_225621_2_, float p_225621_3_, float p_225621_4_, float p_225621_5_, float pScale) {
